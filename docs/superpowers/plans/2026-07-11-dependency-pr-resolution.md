...
```bash
git -C /home/mharman/rust-panosmcp fetch origin main
git -C /home/mharman/rust-panosmcp pull --ff-only origin main
git -C /home/mharman/rust-panosmcp status --short --branch
```
